...
export function TrackingExperience({ orderId }: { orderId: string }) {
  ...
  useEffect(() => {
    ...
    mapRef.current = new mapboxgl.Map({ container: mapContainer.current, style: "mapbox://styles/mapbox/streets-v12", center: [76.7794, 30.7333], zoom: 11, attributionControl: false });
