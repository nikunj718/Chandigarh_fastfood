...
type Assignment = { order_id: string; restaurant_id: string; orders: { id: string; status: string; customer_address_snapshot: { address_text: string }; restaurant_snapshot: { name: string } } };
